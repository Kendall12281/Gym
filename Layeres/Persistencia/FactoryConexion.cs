...
class FactoryConexion
{
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("ExamenGym.Properties.Settings.SQLConnection", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        return ConfigurationManager.ConnectionStrings["ExamenGym.Properties.Settings.SQLConnection"].ConnectionString;
    }
    public static string CreateConnection(string pUsuario, String pContrasena)
    {
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["ExamenGym.Properties.Settings.SQLConnection"].ConnectionString);
        // Agrega al usuario
